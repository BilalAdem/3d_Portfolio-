    ...
    <section className="relative w-full h-screen mx-auto">
      ...
      >
        <div className="flex flex-col justify-center items-center mt-5">
          <div className="relative w-5 h-5 rounded-full bg-[#915eff]" />
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} text-white-100 mt-2`}>
            I'm daytrader by day and a developer by night.
          </p>
        </div>
      </div>
      <ComputersCanvas />

      <div className="absolute xs:bottom-100  w-full flex justify-center items-center ">
        <a href="#about">
